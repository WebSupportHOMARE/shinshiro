...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website:http://ogp.me/ns/website#">
    ...
    <title>送信完了｜ヨガ＆ジム アイレクス・ライト＋24 新城</title>
    ...
    <link rel="canonical" href="https://www.ilex-light.com/shinshiro/contact/">

    <!-- ogp -->
    <meta property="og:type" content="website"> 
    <meta property="og:title" content="送信完了｜ヨガ＆ジム アイレクス・ライト＋24 新城">
    <meta property="og:site_name" content="送信完了｜ヨガ＆ジム アイレクス・ライト＋24 新城">
    ...
    <meta property="og:url" content="https://www.ilex-light.com/shinshiro/contact/">
...
<div id="wrapper" class="home">
    ...
    <main>
        ...
        <div id="form">
            <section>
            <h2 class="tac"><strong>THANK YOU!</strong><span>内容が送信されました</span></h2>

                
                <? include '../../inc/text/newyear.php'; ?>
                <p class="form-text form-text_thanks">この度はお問い合わせいただき、誠にありがとうございます。<br>
                お客様のメールアドレスに自動返信メールをお送りしております。<br>
                <br>
                ※万が一自動返信メールが届いていない場合は、<br>お問い合わせ内容が正しく送信されていない可能性がございます。<br>
                その際は大変恐れ入りますが、お電話にてご連絡をお願いいたします。</p>
