...
$site_top = "https://www.ilex-light.com/shinshiro/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "ilex.formlist7807@gmail.com,honbustaff@ilex-sports.co.jp,light.shinshiro@ilex-sports.co.jp,g-1000012466-322139@mail.talknote.com,g-1000012466-675720@mail.talknote.com";
...
$subject = "[ヨガ＆ジム アイレクス・ライト+24 新城]施設見学・体験のお問い合わせがありました。";
...
$thanksPage = "https://www.ilex-light.com/shinshiro/reservation/thanks.php";
...
$require = array('お申し込み内容','お名前','カナ','電話番号','Email');
...
$re_subject = "[ヨガ＆ジム アイレクス・ライト+24 新城]施設見学・体験のご予約ありがとうございます";
...
このたびは、施設見学・体験のご予約いただきありがとうございます。
