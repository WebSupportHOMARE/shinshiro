                      ...
                      <ul>
                          <li>
                            ...
                            <fieldset class="radiocheck">
                              <label><input class="radio" type="radio" name="お申し込み内容" value="見学申し込み" checked/>見学申し込み（無料）</label>
                              <label><input class="radio" type="radio" name="お申し込み内容" value="ジム施設体験"/>ジム施設体験（1,000円）</label>
                              <label><input class="radio" type="radio" name="お申し込み内容" value="ヨガレッスン体験"/>ヨガレッスン体験（1,000円）</label>
                            </fieldset>
                          </li>
                          <li>
                              <label>
                          ...
                          <li id="date-form">
                              <label>
                                  <span class="ttl">ご来館希望日</span>
                                  <input type="text" id="date" name="ご来館希望日" value="" placeholder="カレンダーから選択してください">
                              </label>
