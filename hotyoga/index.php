        ...
        <div>
            ...
            <section id="mvSec">
                <div>
                    ...
                    <p class="btn poyopoyo"><a href="#formSec"><img src="https://www.ilex-light.com/light-cms/wp-content/uploads/2026/05/btn_top_try_02_2605.png" alt="まずは気軽にお試し♪レッスン体験の予約をする"></a></p>
                </div>
            </section>
            ...
            <div class="try mgt30 mgb30">
                <p><img src="https://www.ilex-light.com/light-cms/wp-content/uploads/2026/05/img_top_try_02_2605.jpg" alt="初めての方大歓迎！レッスン体験受付中！"></p>
                <p class="btn poyopoyo"><a href="#formSec"><img src="https://www.ilex-light.com/light-cms/wp-content/uploads/2026/05/btn_top_try_02_2605.png" alt="まずは気軽にお試し♪レッスン体験の予約をする"></a></p>
            </div>
            ...
            <div class="campaign">
                ...
                <?php
                    if (strtotime(date('Y-m-d H:i')) < strtotime('2026-6-18 00:00')) 
                    {echo '<p><img src="https://www.ilex-light.com/light-cms/wp-content/uploads/2026/05/b374198327e5c6adf202b5d5f6503fe9.png" alt="Summer Shapeキャンペーン"></p>';}  
                    if (strtotime(date('Y-m-d H:i')) > strtotime('2026-6-18 00:00')) 
                    {echo '<p><img src="http://www.ilex-light.com/light-cms/wp-content/uploads/2026/06/71cbb431e31f096cbd18d42aca94f2b6.png" alt="Summer Shapeキャンペーン"></p>';}  
                ?>
            </div>
