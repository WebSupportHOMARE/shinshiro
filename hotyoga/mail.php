...
$site_top = "https://www.ilex-light.com/shinshiro/hotyoga/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "ilex.formlist7807@gmail.com,honbustaff@ilex-sports.co.jp,g-1000012466-322139@mail.talknote.com,g-1000012466-675720@mail.talknote.com,lightstaff@ilex-sports.co.jp";
...
$from = "honbustaff@ilex-sports.co.jp";
...
$Referer_check_domain = "www.ilex-light.com/";
...
$subject = "[ヨガ＆ジム アイレクス・ライト+24 新城]ホットヨガLPよりレッスン体験の申し込みがありました。";
...
$thanksPage = "https://www.ilex-light.com/shinshiro/hotyoga/thanks.php";
...
$require = array('お名前','カナ','電話番号','Email');
...
$refrom_name = "ヨガ＆ジム アイレクス・ライト+24 新城";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "[ヨガ＆ジム アイレクス・ライト+24 新城]体験のお申し込みありがとうございます。";
...
このたびは、ホットヨガ レッスン体験のお申し込みをいただきありがとうございます。
このメールはお客様の入力完了後に送られる自動返信メールです。
担当者から折り返しご連絡いたします。

※こちらのメールは自動送信専用のメールアドレスから送信しています。
ご返信いただいてもお答えできませんので再度お問い合わせフォームより送信ください。
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody="以下の内容でお問い合わせがありました。\n\n";
	$adminBody.="受付日：".date( "Y/m/d (D) H:i:s", time() )."\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
